...
client.scatterFields = ['weight','pulse','basal temp','body temp'];
client.traceField = function (field, type) {
  var trace = {
    x:[],
    y:[],
    type: type,
...
client.traceAverage = function(field, m, y) {
  var average = {
    x:[], y:[],
    type: 'scatter',
    name: 'average',
...
client.traceStatic = function(field, value, source, color) {
...
client.plotField = function (field) {
  var layout = {
...
client.renderTable = function(id) {
...
client.renderRow = function(record, id) {
  var row ='<tr>';
...
client.lastRecordWithField = function(field) {
  for(var i = client.data.length-1; i >= 0; i--) {
...
client.getBMI = function(height, weight) {
  var bmi = '';
  if (height && weight) {
...
client.deleteRecord = function(id, dt) {
